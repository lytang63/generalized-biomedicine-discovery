...
from config import derm12345_dataroot


class Derm12345Dataset(Dataset):
    """
    CSV-driven dataset for Derm12345.
...
def get_derm12345_datasets(
        ...
        train_csv_name="derm12345_labels_half.csv",
        test_csv_name=None,
):
    """
    ...
    train_csv_path = os.path.join(derm12345_dataroot, train_csv_name)
    if test_csv_name is None:
        test_csv_path = train_csv_path
    else:
        test_csv_path = os.path.join(derm12345_dataroot, test_csv_name)

    train_dataset = Derm12345Dataset(
        root=derm12345_dataroot,
