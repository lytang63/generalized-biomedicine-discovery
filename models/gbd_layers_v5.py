...
class SCANv5(nn.Module):
    """
    SCAN (Surprise-evoked Complementary AccommodatioN) - Alternative Version.

    Alternative implementation with deterministic gamma scaling for improved stability.
    """
    def __init__(
        self,
        embed_dim: int,
    ...
    def forward(self, X_patch, cls_token, coords=None, return_explain=False):
        ...
        logits, _ = self.edge_generator(X_patch, cls_token, coords=coords)  # [B,N,E]
