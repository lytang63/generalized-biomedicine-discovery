...
class CLIPnoText(nn.Module):
    ...
    def forward(self, image, clamp_logit_scale_to=None):
        if image is not None:
            image_features, featmap = self.encode_image(image)
        ...
        return image_features, featmap, self.logit_scale.exp()
